...
const stripePromise = loadStripe('pk_test_51RayilHIM3B9fCNDLt5Hh5FyyOj507d03rhQE0qEvnry7T4idydUhhInv4Ce6rLDLcR3VJ0dzli0dj3dyZmK0Vno00EU9GMtTb');
...
const CheckoutPage = () => {
    ...
    return (
        <div style={{ maxWidth: '700px', margin: 'auto', padding: '20px', fontFamily: 'Arial, sans-serif' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', padding: '15px', border: '1px solid #ddd', borderRadius: '8px' }}>
                <input type="text" name="line1" placeholder="Address" onChange={handleAddressChange} style={{ padding: '10px' }} required />
                <input type="text" name="city" placeholder="City" onChange={handleAddressChange} style={{ padding: '10px' }} required />
                <input type="text" name="pincode" placeholder="Pincode" onChange={handleAddressChange} style={{ padding: '10px' }} required />
            </div>
