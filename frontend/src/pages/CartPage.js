...
const CartPage = () => {
    ...
    const handleRemoveFromCart = async (cartItemId) => {
        try {
            ...
            setSelectedItems(currentSelected => currentSelected.filter(id => id !== cartItemId));
        } catch (error) {
    ...
    return (
        <div style={{ maxWidth: '900px', margin: 'auto', padding: '20px' }}>
            ...
            <div style={{ background: '#f0f2f2', padding: '15px', borderRadius: '8px', marginBottom: '20px' }}>
                <h3>
                ...
                <button
                    ...
                    style={{ width: '100%', padding: '12px', fontSize: '16px', backgroundColor: '#ffd814', border: '1px solid #fcd200', borderRadius: '8px', cursor: 'pointer' }}>
                    Proceed to Buy
                </button>
            </div>
            ...
            <div style={{ border: '1px solid #ddd', borderRadius: '8px' }}>
                {cartItems.map(item => (
                    <div key={item._id} style={{ display: 'flex', alignItems: 'center', borderBottom: '1px solid #eee', padding: '15px', gap: '15px' }}>
                        <input
                            type="checkbox"
                        ...
                        />
                        <img src={item.carId.imageUrl} alt={item.carId.name} style={{ width: '120px', height: '80px', objectFit: 'cover', borderRadius: '4px' }} />
                        <div style={{ flex: 1 }}>
